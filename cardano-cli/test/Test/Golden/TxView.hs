  ...
  moduleWorkspace "tmp" $ \tempDir -> do
    ...
    void $
      execCardanoCLI
        ...
        , "--epoch", "64"
        , "--extra-entropy", "c0ffee"
          --  hash(c0ffee) =
          --    88f04f011dcded879039ae4b9b20219d9448e5c7b42c2d1f638fb8740e0ab8be
        , "--genesis-verification-key-file"
        ,   "test/data/golden/shelley/genesis/verification.key"
            -- hash = 81cb0bc5b6fbba391e6f7ec3d9271cbea25bcbf907181b7c4d5f8c2f
  ...
  moduleWorkspace "tmp" $ \tempDir -> do
    ...
    void $
      execCardanoCLI
        ...
        , "--epoch", "190"
        , "--genesis-verification-key-file"
        ,   "test/data/golden/alonzo/genesis/verification.key"
            -- hash = acf9e6314616491ec9e9b9d8c4d4818508f81490affdb99ad1643df2
